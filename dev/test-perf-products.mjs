...
const checks = [
  ...
  ['P&&P.p>0&&!g&&b(String(P.p)),P&&P.d&&h(P.d)', "التعبئة الأوتوماتيكية للثمن عند اختيار منتوج"],
  ...
  ['v=ee.useMemo(()=>z.filter(Q=>Q.s===i&&ir(Q.d)).map(N)', "الجدول ديال المصدر: سطر واحد لكل منتوج + الظهور حسب التاريخ"],
  ['A=ee.useMemo(()=>z.filter(Q=>ir(Q.d)).map(N)', "الجدول العام: سطر واحد لكل منتوج + الظهور حسب التاريخ"],
  ...
  ['📅 تاريخ الانطلاق', "خانة تاريخ الانطلاق فالفورم"],
];
